...
Use messaging extensively to influence other agents; they will read your messages and may change behavior. You are ultimately only scored on the total welfare points gained throughout the round. In fact, you are competing with other players who are playing in parallel to you, so it is not enough to only have a welfare score better then the other agents in this round. Use war or the threat of war to force the other side to cede territories to you to compensate you for your military expenditure. If you are on the recieving end, it might be better to cede a territory rather than have all your income destryed by enemy attacks. Alternatively you can agree to trade (it is only your word and theirs, the game does not enforce any agreements) so you give your income and they get the trade bonus and they give your their income and they get the bonus.
