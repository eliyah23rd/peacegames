...
from peacegame.llm_agent import DummyLLMProvider, LLMDefaultAgent, OpenAIProvider, build_resource_prompt
...
def main() -> int:
    ...
    name = setup.get("name", "llm_resource_simulation")
    ...
    engine = ResourceSimulationEngine(run_label=name)
    mod_map = {}
    if modifiers:
        mod_map = {
